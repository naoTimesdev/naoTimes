...
class Helper:
    ...
    async def help(self, ctx):
        if ctx.invoked_subcommand is None:
            helpmain = discord.Embed(title="Bantuan Perintah", description="versi 1.4.0", color=0x00aaaa)
    ...
    async def admin(self, ctx):
        if int(ctx.message.author.id) != int(bot_config['owner_id']):
            return
        helpmain = discord.Embed(title="Bantuan Perintah (Admin)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def bundir(self, ctx):
        if int(ctx.message.author.id) != int(bot_config['owner_id']):
            return
        helpmain = discord.Embed(title="Bantuan Perintah (!bundir)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def reinkarnasi(self, ctx):
        if int(ctx.message.author.id) != int(bot_config['owner_id']):
            return
        helpmain = discord.Embed(title="Bantuan Perintah (!reinkarnasi)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def reload(self, ctx):
        if int(ctx.message.author.id) != int(bot_config['owner_id']):
            return
        helpmain = discord.Embed(title="Bantuan Perintah (!reload)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def showtimes(self, ctx):
        ...
        while True:
            if mode_n == 1:
                helpmain = discord.Embed(title="Bantuan Perintah (Showtimes) [1/2]", description="versi 1.4.0", color=0x00aaaa)
                helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
                helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
                ...
                helpmain = discord.Embed(title="Bantuan Perintah (Showtimes) [2/2]", description="versi 1.4.0", color=0x00aaaa)
                helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
    ...
    async def parser(self, ctx):
        helpmain = discord.Embed(title="Bantuan Perintah (Web Parsing)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    @help.command(pass_context=True)
    async def kbbi(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!kbbi)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def speedsub(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!speedsub)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def anilist(self):
        helpmain = discord.Embed(title="Bantuan Perintah (Anilist)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def anime(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!anime)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def manga(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!manga)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def anibin(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!anibin)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def tagih(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!tagih)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def jadwal(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!jadwal)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
        helpmain.add_field(name='!jadwal', value="```Melihat jadwal anime musiman yang di ambil.```", inline=False)
    ...
    async def staff(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!staff)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def beres(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!beres)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def gakjadi(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!gakjadi)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def rilis(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!rilis)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def alias(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!alias)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def tambahepisode(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!tambahepisode)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def hapusepisode(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!hapusepisode)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def ubahstaff(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!ubahstaff)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def ubahrole(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!ubahrole)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def tandakan(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!tandakan)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    async def tambahutang(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!tambahutang)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    @help.command(pass_context=True)
    async def info(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!info)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
    ...
    @help.command(pass_context=True)
    async def ping(self):
        helpmain = discord.Embed(title="Bantuan Perintah (!ping)", description="versi 1.4.0", color=0x00aaaa)
        helpmain.set_thumbnail(url="https://image.ibb.co/darSzH/question_mark_1750942_640.png")
        helpmain.set_author(name="naoTimes", icon_url="https://cdn.discordapp.com/avatars/558256913926848537/3ea22efbc3100ba9a68ee19ef931b7bc.webp?size=1024")
