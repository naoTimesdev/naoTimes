...
def parse_args(str_txt: str, s: str, search_mode=True):
    ...
    parser.add_argument(
        ...
        dest="kategori",
        action="append",
        help="Kategori pencarian - cek dengan !perpus kategori",
    )
    parser.add_argument(
        "--user",
        "-u",
        ...
        default=[],
        action="append",
        help="Cari berkas hanya pada user yang diberikan",
    )
    parser.add_argument(
        "--biasa",
        required=False,
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Tambah filter untuk berkas remake",
    )
    parser.add_argument(
        "--trusted",
        required=False,
        default=False,
        action="store_true",
        help="Tambah filter untuk berkas Trusted",
    )
    try:
...
async def fetch_perpus(
    ...
    payload = {"page": 1, "fansub": "", "anime": "", "pageLoad": "lobby"}
    if kategori:
        temp_kat = []
        for k in kategori:
